...
int main() {
    ...
    std::cout << "weight shape size: " << norm.weight.shape.size() << std::endl;
    std::cout << "weight shape[0]: " << norm.weight.shape[0] << std::endl;
    std::cout << "weight numel: " << norm.weight.numel() << std::endl;
    std::cout << "weight data_size: " << norm.weight.data_size << std::endl;
    
    std::cout << "bias shape size: " << norm.bias.shape.size() << std::endl;
    std::cout << "bias shape[0]: " << norm.bias.shape[0] << std::endl;
    std::cout << "bias numel: " << norm.bias.numel() << std::endl;
    std::cout << "bias data_size: " << norm.bias.data_size << std::endl;
