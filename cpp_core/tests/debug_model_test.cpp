...
void test_ecn() {
    ...
    std::cout << "ECN decision shape: [" << output.decision.shape[0] << ", " << output.decision.shape[1] << "]" << std::endl;
...
void test_dmn() {
    ...
    std::cout << "DMN vision shape size: " << output.vision.shape.size() << std::endl;
    for (size_t i = 0; i < output.vision.shape.size(); ++i) std::cout << "  dim " << i << ": " << output.vision.shape[i] << std::endl;
...
void test_sn() {
    ...
    std::cout << "SN saliency shape: [" << output.saliency.shape[0] << ", " << output.saliency.shape[1] << "]" << std::endl;
    std::cout << "SN gates shape: [" << output.gates.shape[0] << ", " << output.gates.shape[1] << "]" << std::endl;
...
void test_memory() {
    ...
    std::cout << "Memory retrieved shape: [" << output.retrieved.shape[0] << ", " << output.retrieved.shape[1] << "]" << std::endl;
