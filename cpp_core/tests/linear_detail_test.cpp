...
int main() {
    ...
    std::cout << "input owns_data: " << input.owns_data << std::endl;
    
    std::cout << "Linear weight shape: [" << linear.weight.shape[0] << ", " << linear.weight.shape[1] << "]" << std::endl;
    std::cout << "Linear weight numel: " << linear.weight.numel() << std::endl;
    std::cout << "Linear weight data_size: " << linear.weight.data_size << std::endl;
    ...
    std::cout << "output data_size: " << output.data_size << std::endl;
    std::cout << "output owns_data: " << output.owns_data << std::endl;
