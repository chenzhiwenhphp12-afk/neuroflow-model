...
void test_knowledge_injection() {
    ...
    std::cout << "  Retrieved memory shape: " << retrieved.retrieved.shape[0] 
              << " x " << retrieved.retrieved.shape[1] << "\n";
...
void test_api_enhanced_reasoning() {
    ...
    std::cout << "  Local reasoning output: " << output.output.shape[0] 
              << " x " << output.output.shape[1] << "\n";
