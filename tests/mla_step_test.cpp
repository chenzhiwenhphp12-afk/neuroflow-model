...
int main() {
    try {
        ...
        std::cout << "   q shape after linear: [" << q.shape_[0] << ", " << q.shape_[1] << "]" << std::endl;
        ...
        std::cout << "   c_kv shape: [" << c_kv.shape_[0] << ", " << c_kv.shape_[1] << "]" << std::endl;
        ...
        std::cout << "   k shape: [" << k.shape_[0] << ", " << k.shape_[1] << "]" << std::endl;
        std::cout << "   v shape: [" << v.shape_[0] << ", " << v.shape_[1] << "]" << std::endl;
